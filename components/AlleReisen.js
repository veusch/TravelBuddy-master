    ...
    <View style={{ flexDirection: "row", flexWrap: "wrap", flex: 1 }}>
      {reisen?.map((item) => (
        ...
        >
          ...
          ) : item.reiseId === "Iyxnkg6cLQ" ? (
            <Image style={{ borderRadius: 20, left: 0, opacity: 0.75, height: "100%", width: "100%", position: "absolute", resizeMode: "cover" }} source={require("../images/demo/strand.jpg")} />
          ) : null}
